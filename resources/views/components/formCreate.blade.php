...
<div x-data="{ formCreate: false }">
    <div class="inline-flex mr-16">
        <button @click="formCreate =!formCreate"
            class="bg-primary w-48 -mr-16 p-1 justify-self-end rounded-full hover:bg-blue-500 text-white">
            + Tambah Jasa
        </button>
    </div>
        ...
        <div
            ...
            <div x-cloak x-show="formCreate" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <div class="flex items-center justify-between space-x-4">
                    <div class="bg-primary w-40 p-1 rounded-full text-white mb-3 mr-4 flex">
                ...
                <form method="post" action="/admin/kelolajasa/">
                    @csrf
                    <div class="p-5">
                        <div>
                            <label for="nama"
